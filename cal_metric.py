...
def get_confuse_matrix(num_classes, label_gts_path, label_preds_path,names):
    ...
    for name in names:
        lt=cv2.imread(((os.path.join(label_gts_path,name[:-4]+'.png'))),0)
        lt = lt.clip(max=1)
...
if __name__ == '__main__':
    # label_gts_path=r'F:\lab\LEVIR-CD\test\label'
    label_gts_path=r'F:\lab\LEVIR-CD\test\label'
    label_preds_path=r'deeplabv3-LEVIR-CD-256_8_100mobilenet'
