...
class Trainer(object):
    def __init__(self, args):
        ...
        # Define network
        model = LightCDNet(backbone=args.backbone, output_stride=16, isdeconv=args.isdeconv)
...
def main():
    ...
    parser.add_argument("--data_root", type=str, default=r'F:\lab\LEVIR-CD',
                        help="path to Dataset,LEVIR-CD,WHU")
    ...
    parser.add_argument('--checkname', type=str, default='deeplabv3-panyu-',
    ...
    args.checkname = args.checkname+str(args.base_size)+"_"+str(args.batch_size)+"_"+str(args.epochs)+str(args.backbone)
